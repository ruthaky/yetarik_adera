...
export default function RootLayout({
	...
	<feSpecularLighting surfaceScale="16" specularConstant="1.7" specularExponent="20" lightingColor="#8b572a" x="0%" y="0%" width="100%" height="100%" in="turbulence" result="specularLighting">
