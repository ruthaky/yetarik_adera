...
export default function BoardMembers({ memberTexts }: { memberTexts: any }) {
  ...
  return (
    <>
      <section className={`${notoSerifEthiopic.variable} flex flex-col md:flex-row justify-center items-start font-notoSerifEthiopic text-gray-800 px-6 md:px-20 pt-[60px] overflow-y-hidden`}>
  ...
  {/* Header */}
  <div className="text-left mb-10 mt-16 flex flex-col justify-center md:justify-start items-center w-full md:w-2/3 text-[#4A2C13]">
